...
static char macrobot_interfaces__msg__FilteredCandidateCrop__FIELD_NAME__result[] = "result";
static char macrobot_interfaces__msg__FilteredCandidateCrop__FIELD_NAME__crop[] = "crop";

static rosidl_runtime_c__type_description__Field macrobot_interfaces__msg__FilteredCandidateCrop__FIELDS[] = {
  {
    {macrobot_interfaces__msg__FilteredCandidateCrop__FIELD_NAME__result, 6, 6},
    {
  ...
  {
    {macrobot_interfaces__msg__FilteredCandidateCrop__FIELD_NAME__crop, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription macrobot_interfaces__msg__FilteredCandidateCrop__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {macrobot_interfaces__msg__FilteredCandidateCrop__FIELDS, 2, 2},
    },
    {macrobot_interfaces__msg__FilteredCandidateCrop__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = macrobot_interfaces__msg__RgbCandidateCrop__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *macrobot_interfaces__msg__FilteredCandidateCrop__get_individual_type_description_source(NULL),
    ...
    sources[4] = *macrobot_interfaces__msg__RgbCandidateCrop__get_individual_type_description_source(NULL);
