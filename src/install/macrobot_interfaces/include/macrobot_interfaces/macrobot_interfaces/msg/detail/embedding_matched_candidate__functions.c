...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__init(macrobot_interfaces__msg__EmbeddingMatchedCandidate * msg)
{
  ...
  // result
  if (!macrobot_interfaces__msg__EmbeddingRetrievalResult__init(&msg->result)) {
    macrobot_interfaces__msg__EmbeddingMatchedCandidate__fini(msg);
    return false;
  }
  // filtered_crop
  if (!macrobot_interfaces__msg__FilteredCandidateCrop__init(&msg->filtered_crop)) {
    macrobot_interfaces__msg__EmbeddingMatchedCandidate__fini(msg);
    return false;
  }
  return true;
...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__fini(macrobot_interfaces__msg__EmbeddingMatchedCandidate * msg)
{
  ...
  // result
  macrobot_interfaces__msg__EmbeddingRetrievalResult__fini(&msg->result);
  // filtered_crop
  macrobot_interfaces__msg__FilteredCandidateCrop__fini(&msg->filtered_crop);
}
...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__are_equal(const macrobot_interfaces__msg__EmbeddingMatchedCandidate * lhs, const macrobot_interfaces__msg__EmbeddingMatchedCandidate * rhs)
{
  ...
  // filtered_crop
  if (!macrobot_interfaces__msg__FilteredCandidateCrop__are_equal(
      &(lhs->filtered_crop), &(rhs->filtered_crop)))
  {
    return false;
  }
  return true;
  ...
  macrobot_interfaces__msg__EmbeddingMatchedCandidate * output)
{
  ...
  if (!macrobot_interfaces__msg__FilteredCandidateCrop__copy(
      &(input->filtered_crop), &(output->filtered_crop)))
  {
    return false;
  }
  return true;
...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__create(void)
{
  ...
  macrobot_interfaces__msg__EmbeddingMatchedCandidate * msg = (macrobot_interfaces__msg__EmbeddingMatchedCandidate *)allocator.allocate(sizeof(macrobot_interfaces__msg__EmbeddingMatchedCandidate), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(macrobot_interfaces__msg__EmbeddingMatchedCandidate));
  bool success = macrobot_interfaces__msg__EmbeddingMatchedCandidate__init(msg);
  if (!success) {
...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence__init(macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  macrobot_interfaces__msg__EmbeddingMatchedCandidate * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(macrobot_interfaces__msg__EmbeddingMatchedCandidate)) {
      return false;
    }
    data = (macrobot_interfaces__msg__EmbeddingMatchedCandidate *)allocator.zero_allocate(size, sizeof(macrobot_interfaces__msg__EmbeddingMatchedCandidate), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = macrobot_interfaces__msg__EmbeddingMatchedCandidate__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        macrobot_interfaces__msg__EmbeddingMatchedCandidate__fini(&data[i - 1]);
      }
...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence__fini(macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      macrobot_interfaces__msg__EmbeddingMatchedCandidate__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence * array = (macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence *)allocator.allocate(sizeof(macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence__init(array, size);
  if (!success) {
...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence__destroy(macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence__are_equal(const macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence * lhs, const macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!macrobot_interfaces__msg__EmbeddingMatchedCandidate__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  macrobot_interfaces__msg__EmbeddingMatchedCandidate__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(macrobot_interfaces__msg__EmbeddingMatchedCandidate)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(macrobot_interfaces__msg__EmbeddingMatchedCandidate);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    macrobot_interfaces__msg__EmbeddingMatchedCandidate * data =
      (macrobot_interfaces__msg__EmbeddingMatchedCandidate *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!macrobot_interfaces__msg__EmbeddingMatchedCandidate__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          macrobot_interfaces__msg__EmbeddingMatchedCandidate__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!macrobot_interfaces__msg__EmbeddingMatchedCandidate__copy(
