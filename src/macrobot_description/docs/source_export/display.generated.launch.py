"""
Launch file for macrobot.

Usage:
    ros2 launch macrobot_description display.launch.py
    ros2 launch macrobot_description display.launch.py namespace:=robot1
"""
...
def generate_launch_description():
    pkg_dir = get_package_share_directory('macrobot_description')

    xacro_file = os.path.join(pkg_dir, 'urdf', 'macrobot.urdf.xacro')
