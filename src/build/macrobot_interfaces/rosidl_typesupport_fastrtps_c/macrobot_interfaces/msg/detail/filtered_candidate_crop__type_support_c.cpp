...
#include "macrobot_interfaces/msg/detail/filtered_candidate_crop__rosidl_typesupport_fastrtps_c.h"
...
#include "macrobot_interfaces/msg/detail/candidate_filter_result__functions.h"  // result
#include "macrobot_interfaces/msg/detail/rgb_candidate_crop__functions.h"  // crop
...
using _FilteredCandidateCrop__ros_msg_type = macrobot_interfaces__msg__FilteredCandidateCrop;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: result
  {
    cdr_serialize_macrobot_interfaces__msg__CandidateFilterResult(
      &ros_message->result, cdr);
  }

  // Field name: crop
  {
    cdr_serialize_macrobot_interfaces__msg__RgbCandidateCrop(
      &ros_message->crop, cdr);
  }
  ...
  macrobot_interfaces__msg__FilteredCandidateCrop * ros_message)
{
  // Field name: result
  {
    cdr_deserialize_macrobot_interfaces__msg__CandidateFilterResult(cdr, &ros_message->result);
  }

  // Field name: crop
  {
    cdr_deserialize_macrobot_interfaces__msg__RgbCandidateCrop(cdr, &ros_message->crop);
  }
...
size_t get_serialized_size_macrobot_interfaces__msg__FilteredCandidateCrop(
  ...
  size_t current_alignment)
{
  const _FilteredCandidateCrop__ros_msg_type * ros_message = static_cast<const _FilteredCandidateCrop__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: result
  current_alignment += get_serialized_size_macrobot_interfaces__msg__CandidateFilterResult(
    &(ros_message->result), current_alignment);

  // Field name: crop
  current_alignment += get_serialized_size_macrobot_interfaces__msg__RgbCandidateCrop(
  ...
  size_t current_alignment)
{
  ...
  // Field name: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_macrobot_interfaces__msg__CandidateFilterResult(
  ...
  // Field name: crop
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_macrobot_interfaces__msg__RgbCandidateCrop(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = macrobot_interfaces__msg__FilteredCandidateCrop;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: result
  {
    cdr_serialize_key_macrobot_interfaces__msg__CandidateFilterResult(
      &ros_message->result, cdr);
  }

  // Field name: crop
  {
    cdr_serialize_key_macrobot_interfaces__msg__RgbCandidateCrop(
      &ros_message->crop, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: result
  current_alignment += get_serialized_size_key_macrobot_interfaces__msg__CandidateFilterResult(
    &(ros_message->result), current_alignment);

  // Field name: crop
  current_alignment += get_serialized_size_key_macrobot_interfaces__msg__RgbCandidateCrop(
    &(ros_message->crop), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_macrobot_interfaces__msg__CandidateFilterResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: crop
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_macrobot_interfaces__msg__RgbCandidateCrop(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const macrobot_interfaces__msg__FilteredCandidateCrop * ros_message = static_cast<const macrobot_interfaces__msg__FilteredCandidateCrop *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_macrobot_interfaces__msg__FilteredCandidateCrop(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  macrobot_interfaces__msg__FilteredCandidateCrop * ros_message = static_cast<macrobot_interfaces__msg__FilteredCandidateCrop *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_macrobot_interfaces__msg__FilteredCandidateCrop(cdr, ros_message);
}

static uint32_t _FilteredCandidateCrop__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_macrobot_interfaces__msg__FilteredCandidateCrop(
...
static size_t _FilteredCandidateCrop__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_macrobot_interfaces__msg__FilteredCandidateCrop(
...
static message_type_support_callbacks_t __callbacks_FilteredCandidateCrop = {
...
static rosidl_message_type_support_t _FilteredCandidateCrop__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FilteredCandidateCrop,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, macrobot_interfaces, msg, FilteredCandidateCrop)() {
  return &_FilteredCandidateCrop__type_support;
}
