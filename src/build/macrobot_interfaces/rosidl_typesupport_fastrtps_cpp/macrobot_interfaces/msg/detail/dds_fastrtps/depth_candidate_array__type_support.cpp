...
#include "macrobot_interfaces/msg/detail/depth_candidate_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const macrobot_interfaces::msg::DepthCandidateArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  macrobot_interfaces::msg::DepthCandidateArray & ros_message)
{
  // Member: header
  ...
  // Member: candidates
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.candidates[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_macrobot_interfaces
max_serialized_size_DepthCandidateArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = macrobot_interfaces::msg::DepthCandidateArray;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_macrobot_interfaces
max_serialized_size_key_DepthCandidateArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const macrobot_interfaces::msg::DepthCandidateArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<macrobot_interfaces::msg::DepthCandidateArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DepthCandidateArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const macrobot_interfaces::msg::DepthCandidateArray *>(
...
static size_t _DepthCandidateArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DepthCandidateArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DepthCandidateArray__callbacks = {
...
static rosidl_message_type_support_t _DepthCandidateArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DepthCandidateArray__callbacks,
...
{
  return &macrobot_interfaces::msg::typesupport_fastrtps_cpp::_DepthCandidateArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, macrobot_interfaces, msg, DepthCandidateArray)() {
  return &macrobot_interfaces::msg::typesupport_fastrtps_cpp::_DepthCandidateArray__handle;
}
