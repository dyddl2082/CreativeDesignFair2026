...
#include "macrobot_interfaces/msg/detail/embedding_matched_candidate__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const macrobot_interfaces::msg::FilteredCandidateCrop &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const macrobot_interfaces::msg::EmbeddingMatchedCandidate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  macrobot_interfaces::msg::EmbeddingMatchedCandidate & ros_message)
{
  // Member: result
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_macrobot_interfaces
max_serialized_size_EmbeddingMatchedCandidate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: filtered_crop
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        macrobot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_FilteredCandidateCrop(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = macrobot_interfaces::msg::EmbeddingMatchedCandidate;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_macrobot_interfaces
max_serialized_size_key_EmbeddingMatchedCandidate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: filtered_crop
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        macrobot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_FilteredCandidateCrop(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const macrobot_interfaces::msg::EmbeddingMatchedCandidate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<macrobot_interfaces::msg::EmbeddingMatchedCandidate *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EmbeddingMatchedCandidate__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const macrobot_interfaces::msg::EmbeddingMatchedCandidate *>(
...
static size_t _EmbeddingMatchedCandidate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EmbeddingMatchedCandidate(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EmbeddingMatchedCandidate__callbacks = {
...
static rosidl_message_type_support_t _EmbeddingMatchedCandidate__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EmbeddingMatchedCandidate__callbacks,
...
{
  return &macrobot_interfaces::msg::typesupport_fastrtps_cpp::_EmbeddingMatchedCandidate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, macrobot_interfaces, msg, EmbeddingMatchedCandidate)() {
  return &macrobot_interfaces::msg::typesupport_fastrtps_cpp::_EmbeddingMatchedCandidate__handle;
}
