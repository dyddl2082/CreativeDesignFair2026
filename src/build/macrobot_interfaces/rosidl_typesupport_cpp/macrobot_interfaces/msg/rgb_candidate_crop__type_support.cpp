...
static const _RgbCandidateCrop_type_support_symbol_names_t _RgbCandidateCrop_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, macrobot_interfaces, msg, RgbCandidateCrop)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, macrobot_interfaces, msg, RgbCandidateCrop)),
  }
};
...
{
  return &::macrobot_interfaces::msg::rosidl_typesupport_cpp::RgbCandidateCrop_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, macrobot_interfaces, msg, RgbCandidateCrop)() {
  return get_message_type_support_handle<macrobot_interfaces::msg::RgbCandidateCrop>();
}
