...
def generate_launch_description():
    ...
    xacro_file = description_pkg / 'urdf' / 'macrobot_full_exact_gripper.urdf.xacro'
    srdf_file = moveit_pkg / 'config' / 'macrobot_full_exact_gripper.srdf'
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'output_directory',
            default_value='~/MacRobot/data/safe_region_exact_gripper',
        ),
        DeclareLaunchArgument(
            'scan_config',
